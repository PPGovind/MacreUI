...
import org.taxilla.com.example.TransformationCreation;
...
public class transformationCreationTest {
    private static final Logger logger = LogManager.getLogger(transformationCreationTest.class);
    ...
    private TransformationCreation transCreation;
    ...
    public void loginDetails() throws Exception {
        ...
        try {
            ...
            transCreation = new TransformationCreation(driver);
    ...
    public void transCreations() throws Throwable {
        logger.info("Starting transformation creation test");
        try {
