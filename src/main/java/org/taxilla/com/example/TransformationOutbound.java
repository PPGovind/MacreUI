...
public class TransformationOutbound {
    private static final Logger logger = LogManager.getLogger(TransformationOutbound.class);
    ...
    public TransformationOutbound(WebDriver driver) {
        this.driver = driver;
    ...
    public void configureTarget() throws InterruptedException, AWTException {
