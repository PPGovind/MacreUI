...
import org.taxilla.com.example.assetInboundTrans;
...
public class assetInboundTest {
    ...
    private assetInboundTrans transCreation;
    ...
    public void loginDetails() throws Exception {
        ...
        try {
            ...
            transCreation = new assetInboundTrans(driver);
