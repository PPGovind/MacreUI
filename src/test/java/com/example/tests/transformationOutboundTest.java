...
import org.taxilla.com.example.TransformationOutbound;
...
public class transformationOutboundTest {
    ...
    private TransformationOutbound transCreation;
    ...
    public void loginDetails() throws Exception {
        ...
        try {
            ...
            transCreation = new TransformationOutbound(driver);
